  ...
  return (
    <div className={styles.statisticsPage}>
      ...
      <div className={styles.gameStatistics}>
        ...
        <div className={styles.gameCard}>
          <h3>Аудиовызов</h3>
          <h4><Check/>Изучено {(data && data.optional?.audioCall?.numberOfNewWords) && 0} слов.</h4>
          <h4><CheckCircle/>Правильных ответов: {(data && data.optional?.audioCall?.numberOfNewWords) && 0}%.</h4>
          <h4><DoneAll/>Самая длинная серия правильных ответов: {(data && data.optional?.audioCall?.numberOfNewWords) && 0}.</h4>
        </div>
      </div>
    </div>
  )
